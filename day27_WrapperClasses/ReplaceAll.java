...
public class ReplaceAll {
    public static void main(String[] args) {
        ...
        arr = replaceAll(arr,30,1000);

        System.out.println(Arrays.toString(arr));

        arr = replaceAll(arr,1000,55);
...
/*
	...
	2. RecplaceAll Task:
		...
		nteger array, integer oldElement, integer newElement.
		The method replaces all the element of the array that
		 matching with the given old element with the given new element, and returns the new array.
			Ex:

...
//1. Create a method that can display the initials of the person.   initials(String firstName,String secondName)
    public static void initials(String firstName,String secondName){
        String ch1 =""+ firstName.toUpperCase().charAt(0);
        String ch2 =""+ secondName.toUpperCase().charAt(0);
...
//4. Create a method that can print the name of the day based on the given number to the method
    public static void nameOfTheDay(int n1){

        String days =   (n1 == 1)? "Monday" :(n1==2)? "Tuesday" :(n1==3)? "Wednesday" :(n1==4)? "Thursday"
...
//5. Create a method that can print how many days a month has
    public static void DayOfTHeMonths(int number){
